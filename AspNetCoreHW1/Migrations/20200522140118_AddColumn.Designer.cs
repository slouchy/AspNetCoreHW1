...
namespace AspNetCoreHW1.Migrations
{
    ...
    [Migration("20200522140118_AddColumn")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AspNetCoreHW1.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("AspNetCoreHW1.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AspNetCoreHW1.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("AspNetCoreHW1.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("AspNetCoreHW1.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AspNetCoreHW1.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("AspNetCoreHW1.Models.Course", b =>
                {
                    b.HasOne("AspNetCoreHW1.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("AspNetCoreHW1.Models.CourseInstructor", b =>
                {
                    b.HasOne("AspNetCoreHW1.Models.Course", "Course")
                    ...
                    b.HasOne("AspNetCoreHW1.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("AspNetCoreHW1.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("AspNetCoreHW1.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("AspNetCoreHW1.Models.OfficeAssignment", b =>
                {
                    b.HasOne("AspNetCoreHW1.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("AspNetCoreHW1.Models.OfficeAssignment", "InstructorId")
